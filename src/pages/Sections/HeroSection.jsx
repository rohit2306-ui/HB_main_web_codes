...
export default function HeroSection () {
  ...
  <CardSwap
      ...
      >
        ...
        <Card key={index} className="border-1 border-gray-50">
          <div className="absolute top-0 left-0 w-full flex justify-between items-center px-4 py-3 bg-black rounded-md mt-1 border-1 border-gray-50 ">
          ...
          <img 
            ...
            className="w-full h-full mt-10 object-cover rounded-[20px] border-2 border-black " 
            style={{ 
