...
const EventsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      {/* Header Section */}
      <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-indigo-100 max-w-2xl mx-auto mb-10">
              Join thousands of professionals at industry-leading conferences,
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-14 pr-5 py-4 rounded-2xl bg-white dark:bg-gray-800 border-0 text-gray-900 dark:text-white shadow-xl focus:ring-4 focus:ring-indigo-500/50 focus:outline-none placeholder-gray-500 text-lg"
                />
              </div>
            </div>
          </div>
